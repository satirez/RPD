...
class ReprocessController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($lotes) ) {
                ...
                $reprocess->lotes()->attach($lotes);

                //se obtiene el id del ultimo
                $reprocess_id = array($reprocess->id);

                array_push($reprocess_id,'l');
                ...
                //se establece la relación con receptions
                 $reprocess->subprocess()->attach($subprocess);

                //se obtiene el id del ultimo
                 $reprocess_id = array($reprocess->id);

                array_push($reprocess_id,'s');
            ...
            return redirect()->route('subreprocess.create', $reprocess_id)->with('success', 'Subprocess guardado con exito');
        }
    }
