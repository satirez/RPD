                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{ $cuentaProcess }}</div>
                                    <div>Procesos de Hoy</div>
                                </div>
                            </div>
                        </div>
                        <a href="{{ url ('processes') }}">
                            <div class="panel-footer">
                                <span class="pull-left">Iniciar proceso</span>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"> {{$cuentaReception}} </div>
                                    <div>Recepciones de hoy</div> 
                                </div>
                            </div>
                        </div>
                        <a href="{{ url ('receptions') }}">
                            <div class="panel-footer">
                                <span class="pull-left">Crear Recepción</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$cuentaDispatch}}</div>
                        ...
                        <a href="{{ url ('dispatch') }}">
                            <div class="panel-footer">
                                <span class="pull-left">Despachar</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
