					...
					<div class="table-responsive">
						<table id="tableReception" class="table table-hover">
							...
							<tbody>
								...
								<tr>
									<th>{{ Form::radio('receptions[]', $reception->id, null, ['value'=>'$reception->id', 'onclick'=>'getWeight(this)']) }} </th>
...
<div class="card">
	<div class="card-header bg-warning">
		<div class="row">
			<div class="col-md-4">
				<h4>Kilos a procesar: {{ Form::text('', null, ['class' => 'form-control', 'id'=>'labelWeight', 'readonly']) }}</h4>
			</div>
		...
		var newChild = '<div class="badge badge-pill badge-primary float-left">' + childNumber + '</div>' +
			...
			` <div class="col-md-12">
					<div class="row">
						...
						<div class="form-group col-md-3">
							<label for="quantity"> Cantidad </label>
							<input class="form-control" id="cantidad" name="row[`+ childNumber +`][cantidad]" type="text">
						</div>
